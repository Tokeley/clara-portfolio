      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 md:grid-cols-3">
        ...
        <ScrollReveal direction="up" className="md:col-span-2">
          <div className="rounded-sm bg-cream px-6 py-8 sm:px-10 sm:py-10">
            ...
            <div className="mt-8 flex flex-col items-center gap-8 sm:flex-row sm:items-end sm:gap-10">
              ...
              <div className="space-y-4 text-[17px] font-normal leading-relaxed text-charcoal/80">
        ...
        <ScrollReveal direction="up" delay={0.2} className="pt-2">
          <h3 className="text-3xl font-bold text-charcoal">Contact</h3>
          <p className="mt-2 text-base font-bold text-charcoal">{name}</p>

          <ul className="mt-6 space-y-4 pl-4 text-base text-charcoal/80">
